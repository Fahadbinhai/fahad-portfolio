...
const AboutMe = () => {
  return (
    <div id='about' className="max-w-3xl lg:max-w-4xl mx-auto mt-12 bg-gradient-to-r from-cyan-700/40 to-blue-900/40 border border-cyan-500/30 rounded-xl shadow-lg px-6 py-8 text-white">
